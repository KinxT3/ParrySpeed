...
local responses = {"lol what", "??", "wdym", "bru what", "con ga, t qua dep trai", "skill issue", "Quangkiet dep trai vai o"}
local gameEndResponses = {"ggs", "gg :3", "good game", "ggs yall", "wp", "hơi non nha"}
local keywords = {"auto parry", "auto", "gian lận", "háck lỏd"}
...
local Window = Rayfield:CreateWindow({
   Name = "Blade Ball",
   LoadingTitle = "Qkiet Scripts",
   LoadingSubtitle = "by Quangkiettrn",
   ConfigurationSaving = {
      Enabled = false,
...
local function startAutoParry()
    print("ok hack chạy ngon rồi em zai")
...
local AutoRagingDeflect = AutoParry:CreateToggle({
    Name = "Auto Rage Parry/Rapture Parry (dùng cái nào ngta hay dùng kìa NGU)",
    CurrentValue = false,
